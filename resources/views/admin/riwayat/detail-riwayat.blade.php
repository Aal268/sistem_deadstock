...
<div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
    ...
    <div class="lg:col-span-4 space-y-6">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h5 class="font-bold text-slate-800 mb-4">Pengakses Detail</h5>
        ...
        <!-- Informasi Kasir (Yang Input Transaksi) -->
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h5 class="font-bold text-slate-800 mb-4">Kasir Penginput</h5>
            <div class="flex items-center gap-3">
                <div class="h-10 w-10 rounded-full bg-secondary/10 flex items-center justify-center text-secondary">
        ...
        <div class="rounded-2xl border border-amber-100 bg-amber-50 p-6 shadow-sm">
            <h5 class="font-bold text-amber-800 mb-2">Aksi Administrator</h5>
            <p class="text-xs text-amber-700 leading-relaxed mb-4">Sebagai admin, Anda memiliki hak untuk mengubah rincian transaksi ini jika terjadi kesalahan input oleh kasir.</p>
            <a href="{{ route('riwayat.edit', $stockMovement->id) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white border border-amber-200 py-2.5 text-xs font-bold text-amber-600 hover:bg-amber-100 transition shadow-sm">
                <i class="fa-solid fa-pen-to-square"></i> Edit Transaksi Ini
            </a>
        </div>
    </div>
</div>
