...
<div class="space-y-8 font-sans">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div class="rounded-2xl bg-alert p-6 text-white shadow-lg shadow-alert/20">
            <h3 class="text-sm font-semibold uppercase tracking-wider text-white/90">Stok Kritis</h3>
            <p class="mt-3 text-5xl font-black leading-none">{{ $criticalStockItems }} <span class="align-middle text-base font-semibold text-white/90">Item</span></p>
        </div>
    </div>
